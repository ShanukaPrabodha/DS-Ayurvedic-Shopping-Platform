  ...
  <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
    <thead class="bg-gray-50">
      <tr>
        ...
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Seller</th>
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Unit Price</th>
        <th scope="col" class="px-6 py-4 font-medium text-gray-900">Option</th>
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100 h-48">
      <tr class="hover:bg-gray-50">
        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
          <div class="relative">
            <img
              class="h-36 w-36 rounded-lg object-cover object-center"
        ...
        <td class="px-6 py-4">
          <div
            class="inline-flex items-center gap-1 rounded-full px-2 py-1 text-s "
          >
           {items.supplier}
          </div>
        </td>
        ...
        <td class="px-6 py-4">
          <div >
            <button onClick={()=>sendCheckout(items)}
                    className="bg-primary-green hover:bg-green-600 text-white w-auto py-1 px-2 rounded-lg">
                <div className="flex gap-2">
                <div>Checkout</div>
                <div className="mt-0.5"><BsArrowRightCircleFill className="fill-green-200"/></div>
                </div>
            </button>
          </div>
        </td>
        <td class="px-6 py-4">
          <div >
            <button  onClick={()=>removeItem(key)}>< RiDeleteBin2Fill className="fill-red-600 w-[20px] h-[20px] hover:fill-red-500 "/></button>
          </div>
        </td>
      </tr>
    </tbody>
