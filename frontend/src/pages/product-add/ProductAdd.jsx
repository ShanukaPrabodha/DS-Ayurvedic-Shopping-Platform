...
const ProductAdd = () => {
	...
	const submitImage =()=>{
		...
		axios.post(`https://api.cloudinary.com/v1_1/${CLOUD_NAME}/image/upload`,data1)
		.then((res)=>{
				...
				<div>
					...
					<div className="block p-8 rounded-3xl shadow-lg bg-white max-w-screen-md max-h-full">
						<form onSubmit={handleSubmit}>
							...
							<div className="">
								<div className="form-group mb-6">
									...
									<div className="form-group mb-6">
										...
										></input>
										<br></br>
										<button className="bg-primary-green px-2" onClick={submitImage}>upload</button>
										</div>
									</div>
									</div>
									</div>
							...
							{show==='F'?(
							<div>
								<div className="bg-green-300 cursor-pointer w-96 rounded-3xl"  onClick={() => toggleVariant()}>Add Variants</div>
								<br></br>
				
							</div>):
							(
							<div>
								<div className="bg-red-300 cursor-pointer w-96 rounded-3xl"  onClick={() => toggleVariant()}>Close</div>
								<br></br>
							</div>)
						}{ show==='T' ?(
							<div>
							...
							<div className="">
								...
								<div className="form-group mb-6">
									...
									<div>
										<button className="bg-blue-400 rounded-3xl shadow-lg w-36" onClick={handleSubmitVariant}>SAVE</button>
									</div>
							</div>
						</div>):(variant.map((a)=>
						<div className="h-auto rounded-3xl shadow-lg py-1">
