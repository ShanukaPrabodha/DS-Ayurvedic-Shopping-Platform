				...
				<div className="flex-col px-10 w-auto md:w-50 py-6 bg-gray-200 rounded-2xl mt-10">
					...
					<div className="flex">
						<div>
							...
							<div className="text-lg font-medium text-black cursor-pointer ml-10 mt-2">
								<b>{buyer.name}</b>
							</div>{" "}
							<div className=" italic text-gray-500">{buyer.email} </div>{" "}
						</div>
				...
				<div className="text-gray-600 body-font">
					<div clasNames="container px-2 py-20 mx-auto">
						<div className="flex flex-col text-center w-full mb-12">
							<h1 className="text-2xl font-medium title-font mb-2 text-gray-900 tracking-widest">PENDING ORDERS</h1>
						</div>
